...
class VocabFile(BaseModel):
    ...
    schemaVersion: int = Field(default=1, description="Schema version")
    words: List[WordEntry] = Field(default_factory=list, description="All vocabulary words")
    memory: List[MemoryState] = Field(default_factory=list, description="Memory states for SRS")
